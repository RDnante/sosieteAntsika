...
@WebServlet(name = "ListProformaServiceRHServlet", value = "/ListProformaServiceRHServlet")
public class ListProformaServiceRHServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            String lien = "Liste_proformaServiceRH";
