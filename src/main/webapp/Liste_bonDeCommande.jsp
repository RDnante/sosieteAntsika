                    ...
                    <tr class="tr-shadow">
                      ...
                      <td>
                        <div class="table-data-feature">
                          <button class="btn btn-info" data-toggle="tooltip" data-placement="top" style="color: white"><a href="BonDeCommandeServlet?id=<%out.print(allF[i].getId_fournisseur());%>">VOIR PROFORMA</a></button>
                        </div>
                      </td>
                    </tr>
                    <% } %>
